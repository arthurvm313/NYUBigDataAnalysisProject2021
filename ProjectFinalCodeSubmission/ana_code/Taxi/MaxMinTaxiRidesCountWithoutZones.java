...
public class MaxMinTaxiRidesCountWithoutZones {
    ...
    {
        Job job = new Job();
        job.setJarByClass(MaxMinTaxiRidesCountWithoutZones.class);
        ...
        job.setMapperClass(MaxMinTaxiRidesCountWithoutZones.MyMapper.class);
        job.setReducerClass(MaxMinTaxiRidesCountWithoutZones.MyReducer.class);
