...
public class MaxMinTaxiRidesCount {
    ...
    {
        Job job = new Job();
        job.setJarByClass(MaxMinTaxiRidesCount.class);
        ...
        job.setMapperClass(MaxMinTaxiRidesCount.MyMapper.class);
        job.setReducerClass(MaxMinTaxiRidesCount.MyReducer.class);
