...
public class AverageTaxiRideDurationWithoutZones {
    ...
    public static class MyMapper extends Mapper<Object, Text, Text, IntWritable>
    {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException
        {
            ...
            int ridesDuration = Integer.parseInt(attributes[2]);
    ...
    {
        Job job = new Job();
        job.setJarByClass(AverageTaxiRideDurationWithoutZones.class);
        ...
        job.setMapperClass(AverageTaxiRideDurationWithoutZones.MyMapper.class);
        job.setReducerClass(AverageTaxiRideDurationWithoutZones.MyReducer.class);
