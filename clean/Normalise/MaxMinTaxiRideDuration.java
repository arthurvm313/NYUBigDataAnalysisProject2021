...
public class MaxMinTaxiRideDuration {
    ...
    public static class MyMapper extends Mapper<Object, Text, Text, IntWritable>
    {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException
        {
            ...
            int duration = Integer.parseInt(attributes[3]);
    ...
    {
        Job job = new Job();
        job.setJarByClass(MaxMinTaxiRideDuration.class);
        ...
        job.setMapperClass(MaxMinTaxiRideDuration.MyMapper.class);
        job.setReducerClass(MaxMinTaxiRideDuration.MyReducer.class);
